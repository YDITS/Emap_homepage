        ...
        <Spacer y={10} />
          <div className="text-center">
           <Container className="mt-50">
             <Text className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">自由</span>を追求しよう。</Text>
